...
def cleanup_and_reseed(apps, schema_editor):
    ServiceCategory = apps.get_model('services', 'ServiceCategory')
    Service = apps.get_model('services', 'Service')

    # Explicitly clear all existing data to ensure a clean state on Railway
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('services', '0003_seed_correct_services'),
    ]

    operations = [
        migrations.RunPython(cleanup_and_reseed),
    ]
